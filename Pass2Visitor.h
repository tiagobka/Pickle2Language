...
public:
    ...
    antlrcpp::Any visitPrintStmt(Pcl2Parser::PrintStmtContext *ctx) override;
    ...
    antlrcpp::Any visitIfStmt(Pcl2Parser::IfStmtContext *ctx) override;
    antlrcpp::Any visitCmprOpExpr(Pcl2Parser::CmprOpExprContext *ctx) override;
    antlrcpp::Any visitKeepGoingStmt(Pcl2Parser::KeepGoingStmtContext *ctx) override;
};
