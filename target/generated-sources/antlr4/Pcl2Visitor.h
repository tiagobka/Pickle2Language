...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitPrintStmt(Pcl2Parser::PrintStmtContext *context) = 0;

    virtual antlrcpp::Any visitIfStmt(Pcl2Parser::IfStmtContext *context) = 0;

    virtual antlrcpp::Any visitKeepGoingStmt(Pcl2Parser::KeepGoingStmtContext *context) = 0;

    virtual antlrcpp::Any visitFormatString(Pcl2Parser::FormatStringContext *context) = 0;

    virtual antlrcpp::Any visitPrintArg(Pcl2Parser::PrintArgContext *context) = 0;
    ...
    virtual antlrcpp::Any visitCmprOpExpr(Pcl2Parser::CmprOpExprContext *context) = 0;
    ...
    virtual antlrcpp::Any visitCmprOp(Pcl2Parser::CmprOpContext *context) = 0;
