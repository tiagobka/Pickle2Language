...
public:
  ...
  virtual antlrcpp::Any visitPrintStmt(Pcl2Parser::PrintStmtContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitKeepGoingStmt(Pcl2Parser::KeepGoingStmtContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitFormatString(Pcl2Parser::FormatStringContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitPrintArg(Pcl2Parser::PrintArgContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitCmprOpExpr(Pcl2Parser::CmprOpExprContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitCmprOp(Pcl2Parser::CmprOpContext *ctx) override {
    return visitChildren(ctx);
  }
